...
export const Services = () => {
  ...
  const [Putfile, PutsetFile] = useState(null);
  ...
  const PuthandleFileChange = (e) => {
    PutsetFile(e.target.files[0]);
  };
  ...
  const Putmutation = useMutation(
    async (formData) => {
      ...
      const response = await axios.put(
        `https://api.dezinfeksiyatashkent.uz/api/services/${editId}`,
        formData,
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const PuthandleSubmit = async (e) => {
    ...
    const formData = new FormData();
    formData.append("images", Putfile);
              ...
              >
                ...
                <div className="faqs-inp-flex">
                  ...
                  <div className="faqs-inp-box">
                    <input
                      type="file"
                      onChange={isEdit ? PuthandleFileChange : handleFileChange}
                    />
                  </div>
                </div>
